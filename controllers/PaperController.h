...
class PaperController : public drogon::HttpController<PaperController>
{
  public:
    ...
    ADD_METHOD_TO(PaperController::upload, "/api/my/papers/upload", drogon::Post, "UserAuthFilter", "RateLimitFilter");
    // Admin routes
    ...
    ADD_METHOD_TO(PaperController::upload, "/api/admin/papers/upload", drogon::Post, "AdminAuthFilter", "RateLimitFilter");
    ADD_METHOD_TO(PaperController::upload, "/api/v1/admin/papers/upload", drogon::Post, "AdminAuthFilter", "RateLimitFilter");
